...
description: Decorators in python are very useful in reducing boilerplate code.
  They extend the functionality of a function. In this blog post, we will deep
  dive into python decorators.
